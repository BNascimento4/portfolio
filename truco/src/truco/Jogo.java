...
public class Jogo {
                ...
                if (cartaEscolhida == -1) {
                    ...
                    if (respostaTruco) {
                    	...
                    	cartaEscolhida = s.nextInt();
                        	...
                        	if(jogando + 1 == 2 || jogando == 4 + 1) timeMaior = 2;
                    		else timeMaior = 1;
                    ...
                    if (cartaMaior == null) {
                    		...
                    		if(jogando + 1 == 1 || jogando + 1 == 3) timeMaior = 1;
                    		else timeMaior = 2;
                }else {
                	if(cartaMaior.forca < pilha.get(pilha.size()-1).forca) {
                		cartaMaior = pilha.get(pilha.size() - 1);
                		if(jogando + 1 == 2 || jogando + 1 == 4) timeMaior = 2;
                		else timeMaior = 1;
                	}
                }
    ...
    private boolean aceitarTruco(int jogadorAtual) {
        int jogadorOponente = (jogadorAtual + 1) % 5;
